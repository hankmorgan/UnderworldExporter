...
//		mysprite.sprite = image;
		...
		myObj.transform.position = pos;
		CreateNPC(myObj,"a_rotworm","Assets/Sprites/objects_064");
		...
		myObj.transform.position = pos;
		CreateNPC(myObj,"a_acid_slug","Assets/Sprites/objects_069");
		...
		myObj.transform.position = pos;
		CreateNPC(myObj,"a_cave_bat","Assets/Sprites/objects_066");
		...
		myObj.transform.position = pos;
		CreateNPC(myObj,"an_outcast","Assets/Sprites/objects_090");
		...
		myObj.transform.position = pos;
		CreateNPC(myObj,"a_giant_rat","Assets/Sprites/objects_067");
		...
		myObj.transform.position = pos;
		CreateNPC(myObj,"a_vampire_bat","Assets/Sprites/objects_073");
		...
		myObj.transform.position = pos;
		CreateNPC(myObj,"a_giant_rat","Assets/Sprites/objects_072");
		...
		myObj.transform.position = pos;
		CreateNPC(myObj,"an_imp","Assets/Sprites/objects_075");
		...
		myObj.transform.position = pos;
		CreateNPC(myObj,"a_lurker","Assets/Sprites/objects_087");
		...
		myObj.transform.position = pos;
		CreateNPC(myObj,"a_giant_spider","Assets/Sprites/objects_068");
		...
		myObj.transform.position = pos;
		CreateNPC(myObj,"a_goblin","Assets/Sprites/objects_077");
		...
		myObj.transform.position = pos;
		CreateNPC(myObj,"a_flesh_slug","Assets/Sprites/objects_065");
		...
		myObj.transform.position = pos;
		CreateNPC(myObj,"a_goblin","Assets/Sprites/objects_071");
		...
		myObj.transform.position = pos;
		CreateNPC(myObj,"a_skeleton","Assets/Sprites/objects_074");
		...
		myObj.transform.position = pos;
		CreateNPC(myObj,"a_goblin","Assets/Sprites/objects_078");
		...
		myObj.transform.position = pos;
		CreateNPC(myObj,"a_goblin","Assets/Sprites/objects_070");
		...
		myObj.transform.position = pos;
		CreateNPC(myObj,"a_goblin","Assets/Sprites/objects_080");
		...
		myObj.transform.position = pos;
		CreateNPC(myObj,"a_goblin","Assets/Sprites/objects_076");
		...
		myObj.transform.position = pos;
		CreateNPC(myObj,"a_wolf_spider","Assets/Sprites/objects_083");
		...
		myObj.transform.position = pos;
		CreateObjectGraphics(myObj,"Sprites/objects_387",true);
		Create_a_do_trap(myObj,3,3887188);
