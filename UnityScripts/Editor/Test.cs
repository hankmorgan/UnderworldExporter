...
//		mysprite.sprite = image;
		...
		myObj.transform.position = pos;
		CreateNPC(myObj,"a_rotworm","Assets/Sprites/objects_064.tga");
		...
		myObj.transform.position = pos;
		CreateNPC(myObj,"a_acid_slug","Assets/Sprites/objects_069.tga");
		...
		myObj.transform.position = pos;
		CreateNPC(myObj,"a_cave_bat","Assets/Sprites/objects_066.tga");
		...
		myObj.transform.position = pos;
		CreateNPC(myObj,"an_outcast","Assets/Sprites/objects_090.tga");
		...
		myObj.transform.position = pos;
		CreateNPC(myObj,"a_giant_rat","Assets/Sprites/objects_067.tga");
		...
		myObj.transform.position = pos;
		CreateNPC(myObj,"a_vampire_bat","Assets/Sprites/objects_073.tga");
		...
		myObj.transform.position = pos;
		CreateNPC(myObj,"a_giant_rat","Assets/Sprites/objects_072.tga");
		...
		myObj.transform.position = pos;
		CreateNPC(myObj,"an_imp","Assets/Sprites/objects_075.tga");
		...
		myObj.transform.position = pos;
		CreateNPC(myObj,"a_lurker","Assets/Sprites/objects_087.tga");
		...
		myObj.transform.position = pos;
		CreateNPC(myObj,"a_giant_spider","Assets/Sprites/objects_068.tga");
		...
		myObj.transform.position = pos;
		CreateNPC(myObj,"a_goblin","Assets/Sprites/objects_077.tga");
		...
		myObj.transform.position = pos;
		CreateNPC(myObj,"a_flesh_slug","Assets/Sprites/objects_065.tga");
		...
		myObj.transform.position = pos;
		CreateNPC(myObj,"a_goblin","Assets/Sprites/objects_071.tga");
		...
		myObj.transform.position = pos;
		CreateNPC(myObj,"a_skeleton","Assets/Sprites/objects_074.tga");
		...
		myObj.transform.position = pos;
		CreateNPC(myObj,"a_goblin","Assets/Sprites/objects_078.tga");
		...
		myObj.transform.position = pos;
		CreateNPC(myObj,"a_goblin","Assets/Sprites/objects_070.tga");
		...
		myObj.transform.position = pos;
		CreateNPC(myObj,"a_goblin","Assets/Sprites/objects_080.tga");
		...
		myObj.transform.position = pos;
		CreateNPC(myObj,"a_goblin","Assets/Sprites/objects_076.tga");
		...
		myObj.transform.position = pos;
		CreateNPC(myObj,"a_wolf_spider","Assets/Sprites/objects_083.tga");
		...
		myObj.transform.position = pos;
		CreateObjectGraphics(myObj,"Assets/Sprites/objects_387.tga",true);
		Create_a_do_trap(myObj,3,4214332);
	...
	static void CreateObjectInteraction(GameObject myObj,float DimX,float DimY,float DimZ)
	{
		//Add a script.
