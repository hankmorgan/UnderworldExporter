		...
		public void Begin()
		{
				...
				switch(_RES)
					...
					case GAME_UW2:
						...
						SetUIElementPosition(playerTrade[0], 16f,16f, new Vector2(130.7f, 180.8f) );
						SetUIElementPosition(playerTrade[1], 16f,16f, new Vector2(151.2f, 180.8f) );
						SetUIElementPosition(playerTrade[2], 16f,16f, new Vector2(130.7f, 163.2f) );
						SetUIElementPosition(playerTrade[3], 16f,16f, new Vector2(151.2f, 163.2f) );

						SetUIElementPosition(npcTrade[0], 16f,16f, new Vector2(81.5f, 180.8f) );
						SetUIElementPosition(npcTrade[1], 16f,16f, new Vector2(102f, 180.8f) );
