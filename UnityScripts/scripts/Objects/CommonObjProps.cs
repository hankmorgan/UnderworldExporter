...
public class CommonObjProps : Props {
		public int[] Height	 = new int[500];
		public int[] Radius	 = new int[500];
		public int[] Animated	 = new int[500];
		public int[] Mass	 = new int[500];
		public int[] Flags0	 = new int[500];
		public int[] Flags1	 = new int[500];
		public int[] Flags2	 = new int[500];
		public int[] Magical	 = new int[500];
		public int[] Decal = new int[500];
		public int[] Pickable	 = new int[500];
		public int[] Flags6 = new int[500];
		public int[] Container	 = new int[500];
		public int[] Value	 = new int[500];
		public int[] QualClass	 = new int[500];
		public int[] Owned	 = new int[500];
		public int[] QualType	 = new int[500];
		public int[] LookAt = new int[500];
