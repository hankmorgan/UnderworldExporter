...
public class TileInfo {
		...
		public short isWater;		//Set when it has a water texture.
		public short isLava;		//Set when it has a lava texture.
		public short hasBridge;//Set when the tile contains a bridge.
